            ...
            <div className="flex flex-col h-full">
              ...
              <div className="mt-6 flex items-center justify-between">
                <div className="text-sm text-gray-700">
                  ...
                  <div className="mt-1"><span className="font-medium">Price:</span> <span className="text-2xl md:text-3xl font-extrabold text-primary-900 ml-2">{currencyFormatter.format(service.price)}</span></div>
                </div>
